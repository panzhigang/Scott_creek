...
void Sunpos::sunpos(cTime udtTime,cLocation udtLocation, cSunCoordinates *udtSunCoordinates)
{
	// Main variables
	...
	// Calculate local coordinates ( azimuth and zenith angle ) in degrees
	{
		...
		dLocalMeanSiderealTime = (dGreenwichMeanSiderealTime*15 
			+ udtLocation.dLongitude)*deg2rad;
		dHourAngle = dLocalMeanSiderealTime - dRightAscension;
		dLatitudeInRadians = udtLocation.dLatitude*deg2rad;
		...
		udtSunCoordinates->dAzimuth = udtSunCoordinates->dAzimuth*rad2deg;
		// Parallax Correction
